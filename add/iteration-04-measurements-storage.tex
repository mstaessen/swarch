\section{Iteration 4: Decomposition of the MeasurementsStorage}
\label{add:it4}
...
\npar The \interface{MeasurementsStorageInstanceAPI} lies in between the
...
\interface{MeasurementsStorageCacheAPI}, similar to the
\interface{MeasurementsStorageInstanceAPI}. The dataflows are equal except for
