...
billing unit needs, first of all it has to have access through the internal ReMeS
...
towards the UISCommunicationUnit. The latter can use this to send predictions to however
needs them.
