...
\npar The Message Router provides the \interface{StorageScheduling} interface.
This interface provides a method \method{schedule(Query)} for scheduling queries on
the trame database.
