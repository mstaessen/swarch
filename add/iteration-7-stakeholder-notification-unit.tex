\section{Iteration 7: Decomposition of the Stakeholder Notification Unit}
\label{add:it7}
...
\begin{figure}[H]
	\begin{centering}
		% TODO
		%\includegraphics[width=0.6\textwidth]{figs/decomposition/stakeholder-notification-unit/decomposition.pdf}
...
the notification. The transport pool offers therefore an \interface{Transport}
interface.
...
%TODO: gaat de prof niet zagen over wat die message nu juist is ? moet ik er
% misschien nog expliciet bij zetten dat dit een formaat is dat gelijk moet zijn
