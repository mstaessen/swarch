...
\method{shedule(QueryCommand)} to schedule new commands.
...
\method{insertCommand(QueryCommand)}.
...
\method{insertCommand(QueryCommand, double)} and \method{remove()}. The first
...
\npar The one and only driver, P3' is resolved in this decomposition. The
