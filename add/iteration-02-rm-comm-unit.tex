...
\method{translateFromDevice(RawTrame) : Message} and
\method{translateToDevice(Message) : RawTrame}. The former serves as translate
...
Subriber} pattern, \method{publish(CommunicationEvent) : void} and
\method{subscribe(Filter) : void}.
