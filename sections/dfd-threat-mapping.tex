...
are merged into a single flow. Firstly, all internal dataflows (i.e. between two
...
for external flows based on assumptions 18 and 19. This leaves only information
