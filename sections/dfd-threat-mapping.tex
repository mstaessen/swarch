...
\begin{table}[H]
	\begin{center}
<<<<<<< HEAD
		\begin{tabular}{p{9cm}ccccccc}
		\toprule[1pt]
=======
		\begin{xtabular}{p{9cm}ccccccc}
		%\toprule[1pt]
>>>>>>> 9dbf8dfdb081f5fbeb8798dc65023bf3829d9509
		\bf Threat target & \bf L & \bf I & \bf N & \bf D & \bf D & \bf U & \bf N \\
		\midrule[0.5pt]
		\multicolumn{8}{c}{\textbf{Data Store}} \\
		\midrule[0.5pt]
		\tmdatastore{Measurements/Information Data}
		\tmdatastore{User Data}
		\tmdatastore{Alarm Configuration Data}
		\midrule[0.5pt]
