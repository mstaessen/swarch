...
\label{vr:whole-system}

\npar We will now list all components and assign more detailed use cases and
quality attribute scenarios to them. They will be the drivers and constraints
