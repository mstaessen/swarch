...
customer database (through the \interface{CustomerProfileAPI} interface) and
needs to be able to contact the UIS. This is done through the \interface{CustomerInformation}.
